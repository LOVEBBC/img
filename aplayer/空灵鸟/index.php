...
if (!wp_is_mobile() || get_option('eaplayer_options')['mobile']) {
    ...
    {
        wp_enqueue_style('player', 'https://cdn.jsdelivr.net/gh/imlzc/img/aplayer/APlayer.min.css', array(), PLAYER_VERSION, 'all');
        wp_enqueue_script('player-js', 'https://cdn.jsdelivr.net/gh/imlzc/img/aplayer/APlayer.min.js', array(), PLAYER_VERSION, true);
        wp_enqueue_script('meting-js', 'https://cdn.jsdelivr.net/gh/imlzc/img/aplayer/Meting.min.js', array(), PLAYER_VERSION, true);
    }
...
{
   add_menu_page('空灵设置', '空灵鸟', 'manage_options', __FILE__, 'eaplayer_page');
}
...
function eaplayer_page()
{
 ...
              <h2 class="eaplayer-page-title">空灵鸟版本：<?php echo PLAYER_VERSION; ?></h2>
 ...
                         <p>如何获得 ID ？在官方分享 URL中复制下来填写进去就好了，关键词仅适用于搜索。</p>
